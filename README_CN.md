...
#多卡训练。
bash ./scripts/run_distribute_train_.sh rank_size rank_start_id rank_table_file
e.g. bash ./scripts/run_distribute_train_.sh 8 0 /data/hccl_8p.json
#GPU多卡训练。
...
训练：生成[RANK_TABLE_FILE](https://gitee.com/mindspore/models/tree/master/utils/hccl_tools)
...
| Parameters                 |                                                        | GPU                                                          |
| -------------------------- | ------------------------------------------------------------ | ------------------------------------------------------------ |
| Resource                   |  910 ；CPU 2.60GHz，192cores; Memory, 755G             | GeForce RTX 3090*8，Intel(R) Xeon(R) Gold 6226R CPU @ 2.90GHz；Memory：256G |
